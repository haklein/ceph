    ...
    for i in $(seq 1 $total_objs) ; do
        ...
        3)
         ...
         7)
            ...
            # Break snapset too
            objectstore_tool $dir $osd $objname set-attr snapset $dir/hdr || return 1
            rm $dir/hdr
            ;;
        ...
        15)
            objectstore_tool $dir $osd $objname rm-attr snapset || return 1
    ...
    jq "$jqfilter" << EOF | python -c "$sortkeys" | sed -e "$sedfilter" > $dir/checkcsjson
{
  "inconsistents": [
    ...
    },
    {
      ...
      "selected_object_info": "2:8b55fa4b:::ROBJ7:head(57'21 client.4415.0:1 dirty|omap|data_digest s 7 uv 21 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [
        "ss_attr_corrupted"
      ],
      "errors": [
    ...
    jq "$jqfilter" << EOF | python -c "$sortkeys" | sed -e "$sedfilter" > $dir/checkcsjson
{
  "inconsistents": [
    ...
    },
    {
      ...
      "selected_object_info": "2:b1f19cbd:::ROBJ10:head(133'49 osd.0.0:6 dirty|omap|data_digest|omap_digest s 7 uv 33 dd 2ddbf8f5 od c2025a24 alloc_hint [0 0 0])",
      "union_shard_errors": [
        "omap_digest_mismatch_oi"
      ],
      "errors": [],
    ...
    },
    {
      ...
      "selected_object_info": "2:87abbf36:::ROBJ11:head(108'36 client.4727.0:1 dirty|omap|data_digest s 7 uv 36 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [
        "read_error"
      ],
      "errors": [],
    ...
    },
    {
      ...
      "selected_object_info": "2:e97ce31e:::ROBJ2:head(22'6 client.4210.0:1 dirty|omap|data_digest s 7 uv 6 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [
        "data_digest_mismatch_oi"
      ],
      "errors": [
    ...
    },
    {
      ...
      "selected_object_info": "2:f4981d31:::ROBJ4:head(36'12 client.4292.0:1 dirty|omap|data_digest s 7 uv 12 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [],
      "errors": [
    ...
    },
    {
      ...
      "selected_object_info": "2:f4bfd4d1:::ROBJ5:head(43'15 client.4333.0:1 dirty|omap|data_digest s 7 uv 15 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [],
      "errors": [
        "omap_digest_mismatch"
      ],
    ...
    },
    {
      ...
      "selected_object_info": "2:a53c12e8:::ROBJ6:head(50'18 client.4374.0:1 dirty|omap|data_digest s 7 uv 18 dd 2ddbf8f5 alloc_hint [0 0 0])",
      "union_shard_errors": [],
      "errors": [
        "omap_digest_mismatch"
      ],
    ...
    },
    {
      "shards": [
        ...
        },
        {
          ...
          "object_info": "2:ffdb2004:::ROBJ9:head(129'50 client.4847.0:1 dirty|omap|data_digest s 3 uv 50 dd 1f26fb26 alloc_hint [0 0 0])",
          "data_digest": "0x1f26fb26",
          "omap_digest": "0x2eecc539",
          "size": 3,
          "errors": [],
      ...
      "selected_object_info": "2:ffdb2004:::ROBJ9:head(129'50 client.4847.0:1 dirty|omap|data_digest s 3 uv 50 dd 1f26fb26 alloc_hint [0 0 0])",
      "union_shard_errors": [],
      "errors": [
        "object_info_inconsistency",
        "attr_value_mismatch"
